...
@section('cont')
    ...
    <div id="tw_content">
        <div class="tw_content_card"  data-aos="fade-down" data-aos-duration="1500">
            <img src="./img/3ds_screen/w_3dsxl_04.jpg" alt="">
        </div>
        <div class="tw_content_card"  data-aos="fade-up" data-aos-duration="1500">
    ...
    <div id="game_pic" data-aos="zoom-in" data-aos-duration="3000"></div>
